...
func TestSimulatedBackend(t *testing.T) {
	...
	tx, _ = types.SignTx(tx, types.NewShanghaiSigner(common.Big1), key)
...
func TestNewAdjustTimeFail(t *testing.T) {
	...
	signedTx, err := types.SignTx(tx, types.NewShanghaiSigner(common.Big1), testKey)
	if err != nil {
	...
	signedTx2, err := types.SignTx(tx2, types.NewShanghaiSigner(common.Big1), testKey)
	if err != nil {
		t.Errorf("could not sign tx: %v", err)
	}
...
func TestForkResendTx(t *testing.T) {
	...
	tx, _ := types.SignTx(_tx, types.NewShanghaiSigner(common.Big1), testKey)
