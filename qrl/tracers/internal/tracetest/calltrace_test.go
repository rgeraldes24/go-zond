...
func TestInternals(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		},
		{
			...
			tracer: mkTracer("callTracer", json.RawMessage(`{ "withLog": true }`)),
			want:   `{"from":"Z000000000000000000000000000000000000feed","gas":"0x13880","gasUsed":"0x5b9e","to":"Z00000000000000000000000000000000deadbeef","input":"0x","logs":[{"address":"Q00000000000000000000000000000000deadbeef","topics":[],"data":""}],"value":"0x0","type":"CALL"}`,
		},
		{
