...
var (
	...
	to2 = common.HexToAddress("Z2")
	to3 = common.HexToAddress("Z3")
	to4 = common.HexToAddress("Z4")
	to5 = common.HexToAddress("Z5")
	txs = Transactions{
		NewTx(&DynamicFeeTx{
			Nonce:     1,
			Value:     big.NewInt(1),
	...
	receipts = Receipts{
		&Receipt{
			...
			// derived fields:
			TxHash:            txs[0].Hash(),
			ContractAddress:   common.HexToAddress("Z5a443704dd4b594b382c22a083e2bd3090a6fef3"),
			GasUsed:           1,
