...
func TestPrecompiledModExp(t *testing.T) {
	testJson("modexp", "Q000000000000000000000000000000000000000000000005", t)
}
func BenchmarkPrecompiledModExp(b *testing.B) {
	benchJson("modexp", "Q000000000000000000000000000000000000000000000005", b)
}

func TestPrecompiledModExpEip2565(t *testing.T) {
	testJson("modexp_eip2565", "Q0000000000000000000000000000000000000000000000f5", t)
}
func BenchmarkPrecompiledModExpEip2565(b *testing.B) {
	benchJson("modexp_eip2565", "Q0000000000000000000000000000000000000000000000f5", b)
}

// Tests the sample inputs from the elliptic curve addition EIP 213.
func TestPrecompiledBn256Add(t *testing.T) {
	testJson("bn256Add", "Q000000000000000000000000000000000000000000000006", t)
}
func BenchmarkPrecompiledBn256Add(b *testing.B) {
	benchJson("bn256Add", "Q000000000000000000000000000000000000000000000006", b)
}
...
func TestPrecompiledModExpOOG(t *testing.T) {
	...
	for _, test := range modexpTests {
		testPrecompiledOOG("Q000000000000000000000000000000000000000000000005", test, t)
	}
}

// Tests the sample inputs from the elliptic curve scalar multiplication EIP 213.
func TestPrecompiledBn256ScalarMul(t *testing.T) {
	testJson("bn256ScalarMul", "Q000000000000000000000000000000000000000000000007", t)
}
func BenchmarkPrecompiledBn256ScalarMul(b *testing.B) {
	benchJson("bn256ScalarMul", "Q000000000000000000000000000000000000000000000007", b)
}

// Tests the sample inputs from the elliptic curve pairing check EIP 197.
func TestPrecompiledBn256Pairing(t *testing.T) {
	testJson("bn256Pairing", "Q000000000000000000000000000000000000000000000008", t)
}
func BenchmarkPrecompiledBn256Pairing(b *testing.B) {
	benchJson("bn256Pairing", "Q000000000000000000000000000000000000000000000008", b)
}

func TestPrecompiledDepositroot(t *testing.T) {
	testJson("depositroot", "Q000000000000000000000000000000000000000000000001", t)
}
