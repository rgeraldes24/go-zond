...
type txtestcase struct {
	from, to, n, g, mfpg, value, d, i string
	expectErr                         bool
	numMessages                       int
}
...
func TestTransactionValidation(t *testing.T) {
	...
	testcases := []txtestcase{
		...
		{from: "000000000000000000000000000000000000dead", to: "000000000000000000000000000000000000dead",
			n: "0x01", g: "0x20", mfpg: "0x40", value: "0x01", numMessages: 1},
		...
		{from: "000000000000000000000000000000000000dead", to: "0x000000000000000000000000000000000000dEaD",
			n: "0x01", g: "0x20", mfpg: "0x40", value: "0x01", numMessages: 0},
		// conflicting input and data
		{from: "000000000000000000000000000000000000dead", to: "0x000000000000000000000000000000000000dEaD",
			n: "0x01", g: "0x20", mfpg: "0x40", value: "0x01", d: "0x01", i: "0x02", expectErr: true},
		// Data can't be parsed
		{from: "000000000000000000000000000000000000dead", to: "0x000000000000000000000000000000000000dEaD",
			n: "0x01", g: "0x20", mfpg: "0x40", value: "0x01", d: "0x0102", numMessages: 1},
		// Data (on Input) can't be parsed
		{from: "000000000000000000000000000000000000dead", to: "0x000000000000000000000000000000000000dEaD",
			n: "0x01", g: "0x20", mfpg: "0x40", value: "0x01", i: "0x0102", numMessages: 1},
		// Send to 0
		...
		{from: "000000000000000000000000000000000000dead", to: "",
			n: "0x01", g: "0x20", mfpg: "0x40", value: "0x00", numMessages: 1},
		// Create empty contract (with value)
		{from: "000000000000000000000000000000000000dead", to: "",
			n: "0x01", g: "0x20", mfpg: "0x40", value: "0x01", expectErr: true},
		// Small payload for create
		{from: "000000000000000000000000000000000000dead", to: "",
			n: "0x01", g: "0x20", mfpg: "0x40", value: "0x01", d: "0x01", numMessages: 1},
	}
