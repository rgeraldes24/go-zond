...
func BenchmarkTransactionTrace(b *testing.B) {
	...
	to := common.HexToAddress("Q00000000000000000000000000000000deadbeef")
	...
	alloc[common.HexToAddress("Q00000000000000000000000000000000deadbeef")] = core.GenesisAccount{
		Nonce:   1,
		Code:    loop,
