...
// TODO(rgeraldes24): for some testcases check why the nonce: 1 is added and the miner does not show up(probably due to not having block rewards with PoS)
// Do same test in go-ethereum for post shanghai and compare results
func TestPrestateWithDiffModeTracer(t *testing.T) {
	...
	tx := types.NewTx(&types.DynamicFeeTx{
		...
		Value:   common.Big0,
		// To:      &to,
		Data:      common.Hex2Bytes(""),
