...
class StdIOHandler:
    ...
    def approveTx(self, req):
        ...
        {"jsonrpc":"2.0","id":20,"method":"ui_approveTx","params":[{"transaction":{"from":"QDEADbEeF000000000000000000000000DeaDbeEf","to":"QDEADbEeF000000000000000000000000DeaDbeEf","gas":"0x3e8","maxFeePerGas":"0x5","maxPriorityFeePerGas":"0x0","value":"0x6","nonce":"0x1","data":"0x"},"call_info":null,"meta":{"remote":"clef binary","local":"main","scheme":"in-proc","User-Agent":"","Origin":""}}]}
