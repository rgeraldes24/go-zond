...
var (
	walletCommand = &cli.Command{
		Name:      "wallet",
		Usage:     "Manage Zond presale wallets",
		ArgsUsage: "",
		Description: `
    gzond wallet import /path/to/my/presale.wallet
		...
		Subcommands: []*cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Zond presale wallet",
				ArgsUsage: "<keyFile>",
				Action:    importWallet,
				Flags: []cli.Flag{
					utils.DataDirFlag,
				...
				Description: `
	gzond wallet [options] /path/to/my/presale.wallet
