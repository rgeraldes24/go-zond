...
|  Command    | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| :--------:  | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **`gzond`** | Our main Zond CLI client. It is the entry point into the Zond network (main-, test- or private net), capable of running as a full node (default) or a archive node (retaining all historical state). It can be used by other processes as a gateway into the Zond network via JSON RPC endpoints exposed on top of HTTP, WebSocket and/or IPC transports. Based on gzond, `gzond --help` and the [gzond CLI page](https://geth.ethereum.org/docs/fundamentals/command-line-options) show command line options. |
